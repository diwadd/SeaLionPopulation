...
counting_model_filename = directories["PARAMETERS_DIRECTORY"] + "counting_model.h5"
train_test_data = dhap.load_train_test_data_trainsmall2(directories, fraction=0.2, data_type="counting")
